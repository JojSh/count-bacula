...
var UnitsCalculator_UnitsCalculator = /*#__PURE__*/function (_React$Component) {
  _inherits(UnitsCalculator, _React$Component);

  var _super = _createSuper(UnitsCalculator);

  function UnitsCalculator(props) {
    var _this;

    _classCallCheck(this, UnitsCalculator);
  ...
  _createClass(UnitsCalculator, [{
    ...
    value: function render() {
      ...
      }), "ml"), /*#__PURE__*/react_default.a.createElement("label", null, "Abv", /*#__PURE__*/react_default.a.createElement("input", {
        type: "number",
        name: "abv",
